...
namespace MyCms.Areas.Admin.Controllers
{
    ...
    public class PagesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PageID,GroupID,Title,ShortDescription,Text,Visit,ImageName,ShowInSlider,CreateDate,Tags")] Page page, HttpPostedFileBase ImageUp)
        {
            if (ModelState.IsValid)
            {
                ...
                if (ImageUp != null)
                {
                    page.ImageName = Guid.NewGuid() + Path.GetExtension(ImageUp.FileName);
                    ImageUp.SaveAs(Server.MapPath("/PageImages/" + page.ImageName));
                }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PageID,GroupID,Title,ShortDescription,Text,Visit,ImageName,ShowInSlider,CreateDate,Tags")] Page page, HttpPostedFileBase ImageUp)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            pageRepository.DelatePage(page);
            pageRepository.Save();
            return RedirectToAction("Index");
        }
